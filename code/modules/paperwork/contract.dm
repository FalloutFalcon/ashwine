...
/obj/item/paper/contract/infernal/power/update_text(signature = "____________", blood = 0)
	...
	var/contract_text
	if(blood)
		contract_text = "<font face=\"Nyala\" color=#600A0A size=6><i>[signature]</i></font>"
	else
		contract_text += "<i>[signature]</i>"
