...
/obj/effect/mob_spawn/ghost_role/drone
	...
	you_are_text = "You are a repair drone. Follow your laws and do not interfere with others."		//WS Edit - Adding missing var

/obj/effect/mob_spawn/ghost_role/drone/Initialize()
	. = ..()
...
/obj/effect/mob_spawn/ghost_role/drone/Destroy()
	GLOB.poi_list -= src
	. = ..()
